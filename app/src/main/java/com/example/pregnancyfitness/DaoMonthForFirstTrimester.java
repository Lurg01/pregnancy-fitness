...
public class DaoMonthForFirstTrimester {
    ...
    public DaoMonthForFirstTrimester(){

        FirebaseDatabase db = FirebaseDatabase.getInstance();
        databaseReference = db.getReference("Users").child(uid).child("First Trimester").child("Months").child("Month: " + months);
