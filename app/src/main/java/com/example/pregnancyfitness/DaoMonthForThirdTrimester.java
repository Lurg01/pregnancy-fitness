...
public class DaoMonthForThirdTrimester {
    ...
    public DaoMonthForThirdTrimester(){

        FirebaseDatabase db = FirebaseDatabase.getInstance();
        databaseReference = db.getReference("Users").child(uid).child("Third Trimester").child("Months").child("Month: " + months);
