...
public class DaoMonthTrimester {
    ...
    public DaoMonthTrimester(){

        FirebaseDatabase db = FirebaseDatabase.getInstance();
        databaseReference = db.getReference("Users").child(uid).child("Cardio for All Trimesters").child("Months").child("Month: " + months);
