...
public class DaoWeekForThirdTrimester {
    ...
    public DaoWeekForThirdTrimester(){

        FirebaseDatabase db = FirebaseDatabase.getInstance();
        databaseReference = db.getReference("Users").child(uid).child("Third Trimester").child("Weeks").child("Week: " + weeks);
