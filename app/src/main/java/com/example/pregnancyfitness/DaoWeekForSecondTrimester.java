...
public class DaoWeekForSecondTrimester {
    ...
    public DaoWeekForSecondTrimester(){

        FirebaseDatabase db = FirebaseDatabase.getInstance();
        databaseReference = db.getReference("Users").child(uid).child("Second Trimester").child("Weeks").child("Week: " + weeks);
